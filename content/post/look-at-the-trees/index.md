...
If we try to use the bone that modern intelligent design proponents throw us when they claim that [form and function are correlated](https://en.wikipedia.org/wiki/Form_follows_function), even this fails here - it's just a copy of the evolutionary prediction, but inverted ([postdiction](https://en.wikipedia.org/wiki/Postdiction): in biology, function (phenotype) follows form (genotype)) and with God slapped on the front (begging the question).
